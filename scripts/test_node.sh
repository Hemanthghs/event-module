...
#
# Examples:
# CHAIN_ID="localchain-1" HOME_DIR="~/.eventchain" BLOCK_TIME="1000ms" CLEAN=true sh scripts/test_node.sh
# CHAIN_ID="localchain-2" HOME_DIR="~/.eventchain" CLEAN=true RPC=36657 REST=2317 PROFF=6061 P2P=36656 GRPC=8090 GRPC_WEB=8091 ROSETTA=8081 BLOCK_TIME="500ms" sh scripts/test_node.sh
...
export HOME_DIR=$(eval echo "${HOME_DIR:-"~/.eventchain"}")
export BINARY=${BINARY:-eventd}
export DENOM=${DENOM:-uevent}
...
from_scratch () {
  ...
  # event1efd63aw40lxf3n4mhf7dzhjkr453axurnfe2w6
  ...
  # event1hj5fveer5cjtn4wd6wstzugjfdxzl0xp0a2w8n
