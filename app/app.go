...
import (
	...
	etm "github.com/rollchains/eventchain/x/etm"
	etmkeeper "github.com/rollchains/eventchain/x/etm/keeper"
	etmtypes "github.com/rollchains/eventchain/x/etm/types"
)
...
func NewChainApp(
	...
	// Create the etm Keeper
	app.EtmKeeper = etmkeeper.NewKeeper(
		appCodec,
		runtime.NewKVStoreService(keys[etmtypes.StoreKey]),
		logger,
		authtypes.NewModuleAddress(govtypes.ModuleName).String(),
	)
	...
	app.ModuleManager = module.NewManager(
		...
		etm.NewAppModule(appCodec, app.EtmKeeper),
	...
	// see cmd/eventd/root.go: 206 - 214 approx
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(etmtypes.ModuleName)
